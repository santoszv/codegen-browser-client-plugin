...
open class GenerateBrowserClientTask : DefaultTask() {
    ...
    private fun generateResourceCode(writer: BufferedWriter, resourceModel: ResourceModel) {
        ...
        writer.newLine()
        writer.write("import mx.com.inftel.codegen.rest.ANTI_REPLAY_TOKEN_HEADER as _codegen_ANTI_REPLAY_TOKEN_HEADER")
        writer.newLine()
        writer.write("import mx.com.inftel.codegen.rest.AUTHENTICATION_TOKEN_HEADER as _codegen_AUTHENTICATION_TOKEN_HEADER")
        writer.newLine()
        writer.write("import mx.com.inftel.codegen.rest.NULL_ANTI_REPLAY_TOKEN as _codegen_NULL_ANTI_REPLAY_TOKEN")
        writer.newLine()
